...
**Formal statement**: For every individual i, there is some profile R and some pair of options A and B such that in R, A >~i~ B, but not A >~∀~ B.
...
I'm not going to make you sit through a proof here. There are a million proofs out there if you want to find one.
...
We'll look at ways out of, or around, the problem.
